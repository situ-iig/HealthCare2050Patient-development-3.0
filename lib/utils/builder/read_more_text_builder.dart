...
class ReadMoreTextBuilder extends StatefulWidget {
  const ReadMoreTextBuilder(
      this.data, {
        Key? key,
        this.preDataText,
        this.postDataText,
  ...
  @override
  ReadMoreTextBuilderState createState() => ReadMoreTextBuilderState();
}
...
class ReadMoreTextBuilderState extends State<ReadMoreTextBuilder> {
  bool _readMore = true;
