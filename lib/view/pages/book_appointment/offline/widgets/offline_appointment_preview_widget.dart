...
class OfflineAppointmentPreviewWidget {
  static Widget doctorDetailsView(DoctorAppointmentModel data) {
    return Card(
      elevation: 5,
      child: Column(
        ...
        children: [
          ...
          showMoreTextView(data.aboutDoctor ?? 'Nothing about doctor')
    ...
    return Card(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("Advance Payment : $currencyRupee 100").paddingSymmetric(horizontal: 10),
          Text("We takes $currencyRupee 100 advance payment for appointment confirmation.",style: TextStyle(
              color: Colors.red,),).paddingSymmetric(horizontal: 10,vertical: 5),
        ],
      ),
    );
  }
