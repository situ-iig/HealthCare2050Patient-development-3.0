...
import 'package:healthcare2050/view/pages/100ms/common/widgets/stream_timer.dart';
import 'package:healthcare2050/view/pages/100ms/common/widgets/subtitle_text.dart';
...
import 'package:healthcare2050/view/pages/100ms/common/bottom_sheets/viewer_settings_bottom_sheet.dart';
                                          ...
                                          return HMSEmbeddedButton(
                                            onTap: () => {
                                              ...
                                              showModalBottomSheet(
                                                ...
                                                shape: topLeftRightShape(borderRadius: 20.0),
                                                context: context,
                                                builder: (ctx) =>
                    ...
                    Selector<MeetingStore, HMSTrackChangeRequest?>(
                        ...
                        builder: (_, hmsTrackChangeRequest, __) {
                          if (hmsTrackChangeRequest != null) {
                            ...
                            context.read<MeetingStore>().hmsTrackChangeRequest =
                                null;
                            WidgetsBinding.instance.addPostFrameCallback((_) {
