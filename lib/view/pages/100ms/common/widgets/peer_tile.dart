...
import 'package:healthcare2050/view/pages/100ms/common/widgets/degrade_tile.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/more_option.dart';
import 'package:healthcare2050/view/pages/100ms/common/widgets/video_view.dart';
...
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/peer_name.dart';
...
class PeerTile extends StatefulWidget {
  ...
  PeerTile(
      ...
      this.isOneToOne = false, required this.userName, required this.userRole})
      : super(key: key);
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    NetworkIconWidget(),
                                    PeerName(userName: widget.userName, userRole: widget.userRole,),
                                  ],
                                ),
                              ),
                            ),
                        ...
                        child: Container(
                          ...
                          child: Center(
                            child: Padding(
                              padding: const EdgeInsets.only(
                                  left: 8.0, right: 4, top: 4, bottom: 4),
                              child: PeerName(userName: widget.userName, userRole: widget.userRole,),
                            ),
                          ),
                        ),
                      ),
