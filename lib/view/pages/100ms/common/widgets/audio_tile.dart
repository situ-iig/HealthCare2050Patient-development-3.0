...
import 'package:healthcare2050/view/pages/100ms/common/app_dialogs/change_role_option_dialog.dart';
import 'package:healthcare2050/view/pages/100ms/common/app_dialogs/change_simulcast_layer_option_dialog.dart';
import 'package:healthcare2050/view/pages/100ms/common/app_dialogs/local_peer_tile_dialog.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/audio_level_avatar.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/audio_mute_status.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/brb_tag.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/hand_raise.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/network_icon_widget.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/rtc_stats_view.dart';
import 'package:healthcare2050/view/pages/100ms/common/peer_widgets/tile_border.dart';
...
import 'package:healthcare2050/view/pages/100ms/common/app_dialogs/remote_peer_tile_dialog.dart';
...
class AudioTile extends StatelessWidget {
  ...
  AudioTile({this.itemHeight = 200.0, this.itemWidth = 200.0, Key? key, required this.userName, required this.userRole})
      : super(key: key);
                  ...
                  child: Center(
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          NetworkIconWidget(),
                          PeerName(userName: userName, userRole: userRole,),
                        ],
                      ),
                    ),
                  ),
