...
import 'package:healthcare2050/view/pages/100ms/common/widgets/peer_tile.dart';
        ...
        if (peerTracks[index].track != null &&
          ...
          return ChangeNotifierProvider.value(
            ...
            child: peerTracks[index].peer.isLocal
              ...
              userName: peerTracks[index].peer.name, userRole: peerTracks[index].peer.role.name,
                  ),
          );
        }
        return ChangeNotifierProvider.value(
            ...
            child: PeerTile(
              ...
              itemHeight: size.height,
              itemWidth: size.width, userName: peerTracks[index].peer.name, userRole: peerTracks[index].peer.role.name,
            ));
      },
