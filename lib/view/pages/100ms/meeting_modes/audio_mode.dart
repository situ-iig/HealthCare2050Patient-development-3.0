...
import 'package:healthcare2050/view/pages/100ms/common/widgets/audio_tile.dart';
    ...
    itemBuilder: (context, index) {
      return ChangeNotifierProvider.value(
          ...
          child: AudioTile(
            ...
            itemWidth: size.width, userName: '${peerTracks[index].peer.name}', userRole: '${peerTracks[index].peer.role}',
          ));
    },
